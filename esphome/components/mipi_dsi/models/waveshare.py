...
DriverChip(
    ...
    color_order="RGB",
    initsequence=[
        # Sleep out + required 120ms wait
        (0x11,),                # Sleep Out
        (0x00, 120),            # <-- delay 120ms

        # Page 0: interface
        (0xFF, 0x98, 0x81, 0x00),
        (0x36, 0x00),           # MADCTL: RGB portrait (use 0x60 or 0x62 for landscape)
        (0x3A, 0x55),           # Pixel format: 16-bit RGB565

        # Page 1: power/drive
        (0xFF, 0x98, 0x81, 0x01),
        (0x00, 0x47), (0x01, 0x22), (0x02, 0x00), (0x03, 0x00),
        (0x04, 0x02), (0x05, 0x2A), (0x06, 0x15), (0x07, 0x21),
        (0x08, 0x0F), (0x0C, 0x1A), (0x0D, 0x1A), (0x0E, 0x3F), (0x0F, 0x3F),
        (0x10, 0x12), (0x11, 0x10), (0x12, 0x00), (0x13, 0x15),
        (0x14, 0x13), (0x15, 0x43), (0x16, 0x0B),

        # Page 2: gamma (balanced)
        (0xFF, 0x98, 0x81, 0x02),
        ...
        # Page 3: VCOM/drive trims (subset used by Waveshare)
        (0xFF, 0x98, 0x81, 0x03),
        (0x00, 0x01), (0x01, 0x01), (0x02, 0x00), (0x03, 0x00),
        (0x04, 0x04), (0x05, 0x1E), (0x06, 0x1E), (0x07, 0x00),
        (0x08, 0x85), (0x09, 0x85), (0x0A, 0x64), (0x0B, 0x64),
        (0x0C, 0x3C), (0x0D, 0x3C),

        # Back to page 0: brightness path + Display ON
        (0xFF, 0x98, 0x81, 0x00),
        (0x53, 0x2C),           # BCTRL=1 (brightness control via 0x51)
        (0x51, 0xFF),           # Panel DCS brightness max
        (0x55, 0x00),           # CABC off (prevents auto-dimming)
        (0x29,),                # Display ON
        (0x00, 20),             # <-- settle 20ms
    ],
)
