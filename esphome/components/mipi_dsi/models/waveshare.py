...
# 7-inch 720x1280 ILI9881C panel (Waveshare 7-DSI-TOUCH-A)
DriverChip(
    ...
    initsequence=[
        ...
        (0x18, 0x06), (0x19, 0x06), (0x1A, 0x0B), (0x1B, 0x0B),
        ...
        # Back to Page 0
        (0xFF, 0x98, 0x81, 0x00),
        (0x53, 0x2C),   # Brightness control
        (0x51, 0xFF),   # Max brightness
        (0x55, 0x00),   # CABC off
        (0x29,), ("delay", 20),   # Display ON
    ],
)
