...
DriverChip(
    ...
    initsequence=[
        ...
        (0x11,),
        # Delay (if driver supports delay opcode) else rely on driver’s built-in sleep out delay
        (0x00, 120),
        ...
        # Page 1 - Power / Drive (using exact values from Waveshare’s C driver)
        (0xFF, 0x98, 0x81, 0x01),
        ...
        # Page 2 - Gamma
        (0xFF, 0x98, 0x81, 0x02),
        (0x00, 0x00), (0x01, 0x08), (0x02, 0x12), (0x03, 0x10),
        (0x04, 0x12), (0x05, 0x19), (0x06, 0x0C), (0x07, 0x13),
        (0x08, 0x06), (0x09, 0x06), (0x0A, 0x0B), (0x0B, 0x0B),
        (0x0C, 0x10), (0x0D, 0x10), (0x0E, 0x10), (0x0F, 0x10),
        (0x10, 0x00), (0x11, 0x08), (0x12, 0x12), (0x13, 0x10),
        (0x14, 0x12), (0x15, 0x19), (0x16, 0x0C), (0x17, 0x13),
        (0x18, 0x06), (0x19, 0x06), (0x1A, 0x0B), (0x1B, 0x1A),  # note maybe slight diff: check official’s 0x1B
        (0x1C, 0x10), (0x1D, 0x10), (0x1E, 0x10), (0x1F, 0x10),

        # Page 3 - VCOM / Voltage / drive parts
        (0xFF, 0x98, 0x81, 0x03),
        ...
        # Return to Page 0 + Display ON + Brightness
        (0xFF, 0x98, 0x81, 0x00),
        (0x53, 0x2C),  # brightness control on
        (0x51, 0xFF),  # max brightness via panel
        (0x55, 0x00),  # disable CABC / auto dimming
        (0x29,),      # Display ON
        (0x00, 20),   # small settle delay
    ],
)
